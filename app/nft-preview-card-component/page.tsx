      ...
      <div className={styles["card"]}>
        ...
        <div className={styles["card-values"]}>
          <div className={clsx(styles["card-value"], styles["card-eth"])}>
            <Image src={`${IMAGES_PREFIX}/icon-ethereum.svg`} alt="" width={11} height={18} />
            0.041 ETH
          </div>
          <div className={clsx(styles["card-value"], styles["card-days"])}>
            <Image src={`${IMAGES_PREFIX}/icon-clock.svg`} alt="" width={17} height={17} />3 days left
          </div>
        </div>
        ...
        <div className={styles["card-avatar"]}>
          <Image src={`${IMAGES_PREFIX}/image-avatar.png`} alt="" width={38} height={38} />
          <span>
            {" "}
